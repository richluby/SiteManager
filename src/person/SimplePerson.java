...
public class SimplePerson implements Serializable {
	...
	@SuppressWarnings("deprecation") final private static Date SENTDATE = new Date(3059,
			12, 31);
	 ...
	 * @throws IOException if the name cannot be parsed */
	...
	public boolean equals(SimplePerson other) {
		if (lastName.equals(other.getLastName()) && firstName
				.equals(other.getFirstName())) { return true;
		}
		return false;
	}
	...
	@Override public String toString(){
		if (lastName.equals("") && firstName.equals("")) { return ""; }
